...
**工作：**
将RNN/LSTM/GRU应用于MNIST测试集上，比较其学习效果。
...
<br>
使用LSTM在RNN/LSTM/GRU数据集上尝试不同的迭代次数，获取训练中的损失值变化和测试准确率。
<div align=center><img width="450" height="450" src="https://github.com/DICKIEZhu/Machine_learning/blob/master/2-7.jpg"/></div>
<div align=center>图 2-7 LSTM在MNIST上的迭代训练16次</div>
<div align=center><img width="450" height="450" src="https://github.com/DICKIEZhu/Machine_learning/blob/master/2-8.png"/></div>
<div align=center>图 2-8 LSTM在FashionMNIST上的迭代训练16次</div>
<div align=center><img width="450" height="450" src="https://github.com/DICKIEZhu/Machine_learning/blob/master/2-9.png"/></div>
<div align=center>图 2-9 LSTM在CIFAR10上的迭代训练16次</div>

<div align=center><img width="450" height="450" src="https://github.com/DICKIEZhu/Machine_learning/blob/master/2-10.png"/></div>
<div align=center>图 2-10 LSTM在MNIST上的迭代训练32次</div>
<div align=center><img width="450" height="450" src="https://github.com/DICKIEZhu/Machine_learning/blob/master/2-11.png"/></div>
<div align=center>图 2-11 LSTM在FashionMNIST上的迭代训练32次</div>
<div align=center><img width="450" height="450" src="https://github.com/DICKIEZhu/Machine_learning/blob/master/2-12.png"/></div>
<div align=center>图 2-12 LSTM在CIFAR10上的迭代训练32次</div>

<div align=center><img width="450" height="450" src="https://github.com/DICKIEZhu/Machine_learning/blob/master/2-13.png"/></div>
<div align=center>图 2-13 LSTM在MNIST上的迭代训练64次</div>
<div align=center><img width="450" height="450" src="https://github.com/DICKIEZhu/Machine_learning/blob/master/2-14.png"/></div>
<div align=center>图 2-14 LSTM在FashionMNIST上的迭代训练64次</div>
<div align=center><img width="450" height="450" src="https://github.com/DICKIEZhu/Machine_learning/blob/master/2-15.png"/></div>
<div align=center>图 2-15 LSTM在CIFAR10上的迭代训练64次</div>
...
<div align=center><img width="450" height="450" src="https://github.com/DICKIEZhu/Machine_learning/blob/master/3-1.png"/></div>
...
<div align=center><img width="450" height="450" src="https://github.com/DICKIEZhu/Machine_learning/blob/master/3-2.png"/></div>
...
<div align=center><img width="450" height="450" src="https://github.com/DICKIEZhu/Machine_learning/blob/master/3-3.png"/></div>
